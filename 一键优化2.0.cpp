...
int main()
{
	...
	{//禁用的程序都不会影响系统使用 请各位大佬放心 
		...
		if(YN==1)
		{
			...
			cout<<"禁用成功，如有报错提示为正常现行";
		}
		cout<<"是否对系统应用进行精简(会禁用较多系统应用 恢复包可恢复)"<<endl<<"输入1 = 精简 输入0 = 不精简"<<endl;
		cin>>YN;
		if(YN==1)
		{
